...
namespace NativeUI
{
    ...
    public delegate void EditableNumericChangeEvent(UIMenu sender, UIMenuEditableNumericItem editableNumericItem, float Value);
    ...
    public class UIMenu
    {
        ...
        /// <summary>
        /// Called when user presses right or left Key.
        /// </summary>
        public event EditableNumericChangeEvent OnValueChange;
        ...
        public void GoLeft()
        {
            ...
            if (MenuItems[CurrentSelection] is UIMenuEditableNumericItem)
            {
                var it = (UIMenuEditableNumericItem)MenuItems[CurrentSelection];
                it.Decrease();
                ValueChange(it, it.Value);
            }
        ...
        protected virtual void ValueChange(UIMenuEditableNumericItem sender, float Value)
        {
            OnValueChange?.Invoke(this, sender, Value);
        }
